# 41_imitate_b16（主题模板包：seaside / 海边）
...
- t2_BGM16：响度 -17.4 dBFS · 宽度 0.678 · 质心 2826Hz
...
& $py scripts\new_song.py 41_imitate_b16 --theme seaside --seed 41
& $py scripts\make_song.py 41_imitate_b16 --check
```
